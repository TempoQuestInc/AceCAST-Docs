...
`~/acecast-v4.3.4`). If it is somewhere else you will need to modify the code examples accordingly.
...
necessary runtime and input files. This will typically include the following:
    ...
    - AceCAST Run Files (always found in `~/acecast-v4.3.4/acecast/run/`):
    ...
    - Simulation Specific Input Data and Configuration Files (found in `~/acecast-v4.3.4/acecast/benchmarks/easter500` for this example):
...
`~/acecast-v4.3.4/acecast/easter500-4GPU`:

.. code-block:: shell

    # Create and cd to new run directory
    mkdir ~/acecast-v4.3.4/acecast/easter500-4GPU
    cd ~/acecast-v4.3.4/acecast/easter500-4GPU
    ...
    .. tab:: output for supported namelist
        ...
        .. code-block:: output
            ...
            ***********************************************************************************
            ...
            WARNING: Namelist file not specified by user. Using default namelist file path: /home/samm.tempoquest/acecast-v4.3.4/acecast/easter500-4GPU/namelist.input 

            Support Check Configuration:
                Namelist                    : /home/samm.tempoquest/acecast-v4.3.4/acecast/easter500-4GPU/namelist.input
                AceCAST Version             : 4.3.4
